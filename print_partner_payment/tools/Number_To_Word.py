...
Number_B_10 = {'fr': {
    71: 'soixante-onze', 72: 'soixante-douze', 73: 'soixante-treize', 74: 'soixante-quatorze', 75: 'soixante-quinze',
    76: 'soixante-seize'
}}
...
def _Number_To_Word_1000(Number, lang):
    ...
    if (Reste == 1):
        ...
        if (Modulo == 0):
            ...
            Word = _Number_To_Word_10(Reste, lang) + ' ' + Number_Mille[lang][1] + ' ' + _Number_To_Word_10(Modulo,
                                                                                                            lang)
        elif (Modulo >= 100 and Modulo < 1000):
            Word = _Number_To_Word_10(Reste, lang) + ' ' + Number_Mille[lang][1] + ' ' + _Number_To_Word_100(Modulo,
                                                                                                             lang)
        else:
            pass
        ...
        if (Modulo == 0):
            ...
            Word = _Number_To_Word_100(Reste, lang) + ' ' + Number_Mille[lang][1] + ' ' + _Number_To_Word_10(Modulo,
                                                                                                             lang)
        elif (Modulo >= 100 and Modulo < 1000):
            Word = _Number_To_Word_100(Reste, lang) + ' ' + Number_Mille[lang][1] + ' ' + _Number_To_Word_100(Modulo,
                                                                                                              lang)
        else:
            pass
...
def _Number_To_Word_Million(Number, lang):
    ...
    if (Reste == 1):
        ...
        if (Modulo == 0):
            Word = Number_1[lang][Reste] + ' ' + Number_Million[lang][1]
        elif (Modulo >= 1 and Modulo < 10):
            Word = Number_1[lang][Reste] + ' ' + Number_Million[lang][1] + ' ' + Number_1[lang][Modulo]
        elif (Modulo >= 10 and Modulo < 100):
            Word = Number_1[lang][Reste] + ' ' + Number_Million[lang][1] + ' ' + _Number_To_Word_10(Modulo, lang)
        elif (Modulo >= 100 and Modulo < 1000):
            Word = Number_1[lang][Reste] + ' ' + Number_Million[lang][1] + ' ' + _Number_To_Word_100(Modulo, lang)
        elif (Modulo >= 1000 and Modulo < 1000000):
            Word = Number_1[lang][Reste] + ' ' + Number_Million[lang][1] + ' ' + _Number_To_Word_1000(Modulo, lang)
        else:
            pass

    elif (Reste < 100 and Reste >= 10):
        if (Modulo == 0):
            Word = _Number_To_Word_10(Reste, lang) + ' ' + Number_Million[lang][1]
        elif (Modulo >= 1 and Modulo < 10):
            Word = _Number_To_Word_10(Reste, lang) + ' ' + Number_Million[lang][1] + ' ' + Number_1[lang][Modulo]
        elif (Modulo >= 10 and Modulo < 100):
            Word = _Number_To_Word_10(Reste, lang) + ' ' + Number_Million[lang][1] + ' ' + _Number_To_Word_10(Modulo,
                                                                                                              lang)
        elif (Modulo >= 100 and Modulo < 1000):
            Word = _Number_To_Word_10(Reste, lang) + ' ' + Number_Million[lang][1] + ' ' + _Number_To_Word_100(Modulo,
                                                                                                               lang)
        elif (Modulo >= 1000 and Modulo < 1000000):
            Word = _Number_To_Word_10(Reste, lang) + ' ' + Number_Million[lang][1] + ' ' + _Number_To_Word_1000(Modulo,
                                                                                                                lang)
        else:
            pass
        ...
        if (Modulo == 0):
            Word = _Number_To_Word_100(Reste, lang) + ' ' + Number_Million[lang][1]
        elif (Modulo >= 1 and Modulo < 10):
            Word = _Number_To_Word_100(Reste, lang) + ' ' + Number_Million[lang][1] + ' ' + Number_1[lang][Modulo]
        elif (Modulo >= 10 and Modulo < 100):
            Word = _Number_To_Word_100(Reste, lang) + ' ' + Number_Million[lang][1] + ' ' + _Number_To_Word_10(Modulo,
                                                                                                               lang)
        elif (Modulo >= 100 and Modulo < 1000):
            Word = _Number_To_Word_100(Reste, lang) + ' ' + Number_Million[lang][1] + ' ' + _Number_To_Word_100(Modulo,
                                                                                                                lang)
        elif (Modulo >= 1000 and Modulo < 1000000):
            Word = _Number_To_Word_100(Reste, lang) + ' ' + Number_Million[lang][1] + ' ' + _Number_To_Word_1000(Modulo,
                                                                                                                 lang)
        else:
            pass
            ...
            if (isNumber.match(Number)):
                ...
                if (firstNumber >= 0 and firstNumber < 10):
                    if (firstNumber == 0 and endNumber != 0):
                        ...
                        Word = Number_1[lang][firstNumber] + ' ' + Devise + ' ' + _Number_To_Word_10(endNumber,
                                                                                                     lang) + ' ' + Devise2
                elif (firstNumber >= 10 and firstNumber < 100):
                    if (endNumber != 0):
                        Word = _Number_To_Word_10(firstNumber, lang) + ' ' + Devise + ' ' + _Number_To_Word_10(
                            endNumber, lang) + ' ' + Devise2
                    else:
                        Word = _Number_To_Word_10(firstNumber, lang) + ' ' + Devise + ' ' + _Number_To_Word_10(
                            endNumber, lang)
                elif (firstNumber >= 100 and firstNumber < 1000):
                    if (endNumber != 0):
                        Word = _Number_To_Word_100(firstNumber, lang) + ' ' + Devise + ' ' + _Number_To_Word_10(
                            endNumber, lang) + ' ' + Devise2
                    else:
                        Word = _Number_To_Word_100(firstNumber, lang) + ' ' + Devise + ' ' + _Number_To_Word_10(
                            endNumber, lang)
                    ...
                    if (endNumber != 0):
                        Word = _Number_To_Word_1000(firstNumber, lang) + ' ' + Devise + ' ' + _Number_To_Word_10(
                            endNumber, lang) + ' ' + Devise2
                    else:
                        Word = _Number_To_Word_1000(firstNumber, lang) + ' ' + Devise + ' ' + _Number_To_Word_10(
                            endNumber, lang)
                    ...
                    if (endNumber != 0):
                        Word = _Number_To_Word_Million(firstNumber, lang) + ' ' + Devise + ' ' + _Number_To_Word_10(
                            endNumber, lang) + ' ' + Devise2
                    else:
                        Word = _Number_To_Word_Million(firstNumber, lang) + ' ' + Devise + ' ' + _Number_To_Word_10(
                            endNumber, lang)
